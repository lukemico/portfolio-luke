		...
		<div className="container px-4 mx-auto">
			<div className="lg:space-x-5 lg:flex lg:flex-row item-center lg:-mx-4 flex flex-col-reverse text-center lg:text-left">
				<div class="lg:px-4 lg:mt-12 ">
					<h1 class="text-2xl font-bold text-gray-900 lg:text-5xl dark:text-white">
						Hey, I’m Luke.
					</h1>
					<div class="mt-6 text-gray-800 dark:text-white">
						<p class="mb-4">
							I'm a Software Developer and Polymath. I work as a
							Front End Developer at{' '}
							<a
								href="https://www.sydneyoperahouse.com/"
								class="font-bold transition-colors hover:text-sky-500"
								target="_blank"
								rel="noreferrer"
							>
								Sydney Opera House.
				...
				<div className="flex-shrink-0 lg:mt-12 lg:px-4 mb-10">
					...
					<div class="flex justify-center mt-6">
						<div class="flex md:flex lg:flex space-x-4 font-medium text-gray-800 sm:block dark:text-white">
							<a
								class="transition-colors hover:text-sky-500"
								target="_blank"
								rel="noreferrer"
								href="https://twitter.com/lukemico"
							>
								<svg
									stroke="currentColor"
									fill="currentColor"
							...
							<a
								...
								target="_blank"
								rel="noreferrer"
								href="https://www.linkedin.com/in/lukemico/"
							>
								<svg
									stroke="currentColor"
									fill="currentColor"
							...
							<a
								...
								target="_blank"
								rel="noreferrer"
								href="https://github.com/lukemico"
							>
								<svg
									stroke="currentColor"
									fill="currentColor"
